<!DOCTYPE html>
<!--Author: Paola Gema Mamani Janco-->
<html lang="en">
    <?php $this->load->view('estructura/general/head_begin') ?>
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">		
		<?php $this->load->view('estructura/general/head_mobile') ?>
		<div class="d-flex flex-column flex-root">
			<div class="d-flex flex-row flex-column-fluid page">				
                <?php $this->load->view('estructura/viceministerio/menu_lateral') ?>
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper"><!--begin::Wrapper-->
					<?php $this->load->view('estructura/general/head_menu') ?>
									...
									<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
										<a href="#" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<span class="svg-icon svg-icon-success svg-icon-lg">
												<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/Files/File-plus.svg-->
													...
													<div class="row m-0">
														<div class="col bg-white px-6 py-8 rounded-xl mr-7">
															<span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
																<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/Design/Layers.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<polygon points="0 0 24 0 24 24 0 24" />
														...
														<div class="col bg-white px-6 py-8 rounded-xl">
															<span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
																<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/Communication/Urgent-mail.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<rect x="0" y="0" width="24" height="24" />
																...
																<div class="symbol symbol-45 symbol-light-primary mr-4 flex-shrink-0">
																	<div class="symbol-label">
																		<span class="svg-icon svg-icon-lg svg-icon-primary">
																			<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/Shopping/Barcode-read.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24" />
												...
												<div class="mt-5">
													...
													<div class="d-flex align-items-center justify-content-between mb-5">
														...
														<div class="d-flex align-items-center mr-2">
															...
															<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
																<div class="symbol-label">
																	<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/misc/006-plurk.svg" class="h-50" alt="" />
																</div>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
													...
													<div class="d-flex align-items-center justify-content-between mb-5">
														...
														<div class="d-flex align-items-center mr-2">
															...
															<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
																<div class="symbol-label">
																	<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/misc/015-telegram.svg" class="h-50" alt="" />
																</div>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
													...
													<div class="d-flex align-items-center justify-content-between">
														...
														<div class="d-flex align-items-center mr-2">
															...
															<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
																<div class="symbol-label">
																	<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/misc/003-puzzle.svg" class="h-50" alt="" />
																</div>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
													...
													<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
														<div class="symbol-label" style="background-image: url('<?php echo base_url(); ?>recursos_metronics/assets/media/stock-600x400/img-17.jpg')"></div>
													</div>
													<!--end::Symbol-->
													<!--begin::Title-->
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
													<!--begin::Symbol-->
													<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
														<div class="symbol-label" style="background-image: url('<?php echo base_url(); ?>recursos_metronics/assets/media/stock-600x400/img-10.jpg')"></div>
													</div>
													<!--end::Symbol-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
													<!--begin::Symbol-->
													<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
														<div class="symbol-label" style="background-image: url('<?php echo base_url(); ?>recursos_metronics/assets/media/stock-600x400/img-1.jpg')"></div>
													</div>
													<!--end::Symbol-->
													<!--begin::Title-->
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
													<!--begin::Symbol-->
													<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
														<div class="symbol-label" style="background-image: url('<?php echo base_url(); ?>recursos_metronics/assets/media/stock-600x400/img-9.jpg')"></div>
													</div>
													<!--end::Symbol-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
														...
														<tbody>
																...
																<td class="pr-0">
																	<div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="" />
																		</span>
																	</div>
																</td>
																<td class="pl-0">
																...
																<td class="pr-0 text-right">
																	<a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/General/Settings-1.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24" />
																	...
																	<a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/General/Trash.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24" />
															...
															<tr>
																...
																<td class="pr-0">
																	<div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="" />
																		</span>
																	</div>
																</td>
																<td class="pl-0">
															...
															<tr>
																...
																<td class="pr-0">
																	<div class="symbol symbol-50 symbol-lightv mt-1">
																		<span class="symbol-label">
																			<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="" />
																		</span>
																	</div>
																</td>
																<td class="pl-0">
															...
															<tr>
																...
																<td class="pr-0">
																	<div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="<?php echo base_url(); ?>recursos_metronics/assets/media/svg/avatars/014-girl-7.svg" class="h-75 align-self-end" alt="" />
																		</span>
																	</div>
																</td>
																<td class="pl-0">
													...
													<tr class="text-uppercase">
														...
														<th style="min-width: 150px">
															...
															<span class="svg-icon svg-icon-sm svg-icon-primary">
																<!--begin::Svg Icon | path:<?php echo base_url(); ?>recursos_metronics/assets/media/svg/icons/Navigation/Down-2.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<polygon points="0 0 24 0 24 24 0 24" />
					...
					<?php $this->load->view('estructura/general/footer') ?>
				</div><!--end::Wrapper-->
			</div>
		</div>
        <?php $this->load->view('estructura/general/panel_modal') ?>
        <?php $this->load->view('estructura/general/footer_begin') ?>	
	</body>
	<!--end::Body-->
</html>